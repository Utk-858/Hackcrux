...
const sampleBookings = [
  ...
  },
  {
    ...
    place: {
      ...
      photos: ['/images/mountain-cabin.jpg'],
    },
    price: 12000,
          ...
          bookings.map((booking) => (
            ...
            >
              ...
              <div className="grow py-3 pr-3">
                ...
                <BookingDates booking={booking} className="mb-2 mt-4 hidden items-center text-gray-600 md:flex" />
                <div className="my-2 flex items-center gap-1">
                  ...
                  <span className="text-xl md:text-2xl">Total price: ₹{booking.price}</span>
                </div>
              </div>
            </Link>
          ))
