...
const BookingWidget = ({ place }) => {
  ...
  const handleBooking = () => {
    ...
    const mockBookingId = Date.now(); // Generates a unique booking ID
    setRedirect(`/account/bookings/${mockBookingId}`);
    toast('Congratulations! Your booking has been confirmed.');
  };
